...
C - - - - - 0x00C032 03:A022: 85 0A     STA ram_000A
...
C - - - - - 0x00C047 03:A037: A5 29     LDA ram_0029
...
C - - - - - 0x00C05D 03:A04D: 85 7B     STA ram_chr_bank + 4
...
C - - - - - 0x00C091 03:A081: B9 83 07  LDA ram_0782_unk + 1,Y
C - - - - - 0x00C094 03:A084: D0 1B     BNE bra_A0A1_loop
C - - - - - 0x00C096 03:A086: A9 28     LDA #$28
C - - - - - 0x00C098 03:A088: 99 83 07  STA ram_0782_unk + 1,Y
C - - - - - 0x00C09B 03:A08B: A9 00     LDA #$00
C - - - - - 0x00C09D 03:A08D: 99 D3 07  STA ram_07D2_unk + 1,Y
...
C - - - - - 0x00C0F3 03:A0E3: AD 84 07  LDA ram_0782_unk + 2
...
C - - - - - 0x00C0FE 03:A0EE: AD 02 06  LDA ram_0600_obj + 2
...
bra_A10B:
C - - - - - 0x00C11B 03:A10B: 20 5E A3  JSR sub_A35E
...
C - - - - - 0x00C12F 03:A11F: B1 08     LDA (ram_0008),Y
C - - - - - 0x00C131 03:A121: 85 0A     STA ram_000A
C - - - - - 0x00C133 03:A123: C8        INY
C - - - - - 0x00C134 03:A124: B1 08     LDA (ram_0008),Y
C - - - - - 0x00C136 03:A126: 85 0B     STA ram_000B
C - - - - - 0x00C138 03:A128: A0 00     LDY #$00
loc_A12A:
bra_A12A_loop:
C D 1 - - - 0x00C13A 03:A12A: B1 0A     LDA (ram_000A),Y
...
C - - - - - 0x00C162 03:A152: E5 00     SBC ram_0000
...
C - - - - - 0x00C19C 03:A18C: A5 0C     LDA ram_000C
C - - - - - 0x00C19E 03:A18E: 99 68 06  STA ram_obj_pos_Y,Y
C - - - - - 0x00C1A1 03:A191: 20 A3 A3  JSR sub_A3A3
bra_A194:
loc_A194:
C - - - - - 0x00C1A4 03:A194: A4 06     LDY ram_0006
C - - - - - 0x00C1A6 03:A196: C8        INY
C - - - - - 0x00C1A7 03:A197: 4C 2A A1  JMP loc_A12A



sub_A19A:
C - - - - - 0x00C1AA 03:A19A: C8        INY
C - - - - - 0x00C1AB 03:A19B: B1 0A     LDA (ram_000A),Y
C - - - - - 0x00C1AD 03:A19D: 85 0C     STA ram_000C
...
sub_A1A3:
C - - - - - 0x00C1B3 03:A1A3: A5 1C     LDA ram_001C
...
loc_A1B7:
C D 1 - - - 0x00C1C7 03:A1B7: 20 52 A3  JSR sub_A352
C - - - - - 0x00C1CA 03:A1BA: A4 88     LDY ram_x2_stage
C - - - - - 0x00C1CC 03:A1BC: B9 E5 A2  LDA tbl_A2E5,Y
C - - - - - 0x00C1CF 03:A1BF: 85 0E     STA ram_000E
C - - - - - 0x00C1D1 03:A1C1: B9 E6 A2  LDA tbl_A2E5 + 1,Y
C - - - - - 0x00C1D4 03:A1C4: 85 0F     STA ram_000F
C - - - - - 0x00C1D6 03:A1C6: A9 00     LDA #$00
C - - - - - 0x00C1D8 03:A1C8: 85 19     STA ram_0019
C - - - - - 0x00C1DA 03:A1CA: A5 23     LDA ram_0023
...
C - - - - - 0x00C1EB 03:A1DB: 85 18     STA ram_0018
loc_A1DD:
...
C - - - - - 0x00C1F9 03:A1E9: 85 1A     STA ram_001A
C - - - - - 0x00C1FB 03:A1EB: A5 64     LDA ram_0064
C - - - - - 0x00C1FD 03:A1ED: 29 F8     AND #$F8
C - - - - - 0x00C1FF 03:A1EF: 85 0C     STA ram_000C
loc_A1F1:
C D 1 - - - 0x00C201 03:A1F1: A0 00     LDY #$00
C - - - - - 0x00C203 03:A1F3: B1 0A     LDA (ram_000A),Y
C - - - - - 0x00C205 03:A1F5: C9 FF     CMP #$FF
C - - - - - 0x00C207 03:A1F7: F0 60     BEQ bra_A259
C - - - - - 0x00C209 03:A1F9: A5 19     LDA ram_0019
C - - - - - 0x00C20B 03:A1FB: F0 08     BEQ bra_A205
C - - - - - 0x00C20D 03:A1FD: B1 0A     LDA (ram_000A),Y
C - - - - - 0x00C20F 03:A1FF: C5 1A     CMP ram_001A
C - - - - - 0x00C211 03:A201: B0 50     BCS bra_A253
C - - - - - 0x00C213 03:A203: 90 06     BCC bra_A20B    ; jmp
bra_A205:
C - - - - - 0x00C215 03:A205: B1 0A     LDA (ram_000A),Y
C - - - - - 0x00C217 03:A207: C5 1A     CMP ram_001A
C - - - - - 0x00C219 03:A209: 90 48     BCC bra_A253
bra_A20B:
C - - - - - 0x00C21B 03:A20B: 85 1B     STA ram_001B
C - - - - - 0x00C21D 03:A20D: C8        INY
C - - - - - 0x00C21E 03:A20E: B1 0A     LDA (ram_000A),Y
C - - - - - 0x00C220 03:A210: 29 F8     AND #$F8
C - - - - - 0x00C222 03:A212: C5 0C     CMP ram_000C
...
C - - - - - 0x00C22D 03:A21D: A5 1C     LDA ram_001C
...
bra_A248:
C - - - - - 0x00C258 03:A248: A5 1B     LDA ram_001B
C - - - - - 0x00C25A 03:A24A: 38        SEC
C - - - - - 0x00C25B 03:A24B: E5 1A     SBC ram_001A
...
bra_A259:
C - - - - - 0x00C269 03:A259: E6 19     INC ram_0019
C - - - - - 0x00C26B 03:A25B: A5 19     LDA ram_0019
C - - - - - 0x00C26D 03:A25D: 29 01     AND #$01
C - - - - - 0x00C26F 03:A25F: F0 05     BEQ bra_A266_RTS
C - - - - - 0x00C271 03:A261: E6 18     INC ram_0018
...
C - - - - - 0x00C281 03:A271: 85 18     STA ram_0018
C - - - - - 0x00C283 03:A273: A5 69     LDA ram_0069
C - - - - - 0x00C285 03:A275: 30 02     BMI bra_A279
C - - - - - 0x00C287 03:A277: E6 18     INC ram_0018
bra_A279:
C - - - - - 0x00C289 03:A279: 20 1F A3  JSR sub_A31F
C - - - - - 0x00C28C 03:A27C: A5 64     LDA ram_0064
C - - - - - 0x00C28E 03:A27E: 85 1A     STA ram_001A
C - - - - - 0x00C290 03:A280: A5 61     LDA ram_0061
C - - - - - 0x00C292 03:A282: 29 FC     AND #$FC
C - - - - - 0x00C294 03:A284: 85 0C     STA ram_000C
loc_A286:
C D 1 - - - 0x00C296 03:A286: A0 00     LDY #$00
C - - - - - 0x00C298 03:A288: B1 0A     LDA (ram_000A),Y
C - - - - - 0x00C29A 03:A28A: 85 0D     STA ram_000D
C - - - - - 0x00C29C 03:A28C: C9 FF     CMP #$FF
C - - - - - 0x00C29E 03:A28E: F0 47     BEQ bra_A2D7
C - - - - - 0x00C2A0 03:A290: C8        INY
C - - - - - 0x00C2A1 03:A291: A5 19     LDA ram_0019
C - - - - - 0x00C2A3 03:A293: F0 08     BEQ bra_A29D
C - - - - - 0x00C2A5 03:A295: B1 0A     LDA (ram_000A),Y
C - - - - - 0x00C2A7 03:A297: C5 1A     CMP ram_001A
C - - - - - 0x00C2A9 03:A299: B0 2A     BCS bra_A2C5
C - - - - - 0x00C2AB 03:A29B: 90 06     BCC bra_A2A3    ; jmp
bra_A29D:
C - - - - - 0x00C2AD 03:A29D: B1 0A     LDA (ram_000A),Y
C - - - - - 0x00C2AF 03:A29F: C5 1A     CMP ram_001A
C - - - - - 0x00C2B1 03:A2A1: 90 22     BCC bra_A2C5
bra_A2A3:
C - - - - - 0x00C2B3 03:A2A3: 85 1B     STA ram_001B
C - - - - - 0x00C2B5 03:A2A5: A5 0D     LDA ram_000D
C - - - - - 0x00C2B7 03:A2A7: 29 FC     AND #$FC
C - - - - - 0x00C2B9 03:A2A9: C5 0C     CMP ram_000C
...
C - - - - - 0x00C2CA 03:A2BA: A5 1B     LDA ram_001B
C - - - - - 0x00C2CC 03:A2BC: 38        SEC
C - - - - - 0x00C2CD 03:A2BD: E5 1A     SBC ram_001A
...
sub_A2CB:
C - - - - - 0x00C2DB 03:A2CB: A5 0A     LDA ram_000A
C - - - - - 0x00C2DD 03:A2CD: 18        CLC
C - - - - - 0x00C2DE 03:A2CE: 69 04     ADC #$04
C - - - - - 0x00C2E0 03:A2D0: 85 0A     STA ram_000A
C - - - - - 0x00C2E2 03:A2D2: 90 02     BCC bra_A2D6_RTS
C - - - - - 0x00C2E4 03:A2D4: E6 0B     INC ram_000B
bra_A2D6_RTS:
C - - - - - 0x00C2E6 03:A2D6: 60        RTS
bra_A2D7:
C - - - - - 0x00C2E7 03:A2D7: E6 19     INC ram_0019
C - - - - - 0x00C2E9 03:A2D9: A5 19     LDA ram_0019
...
C - - - - - 0x00C2F2 03:A2E2: 4C 6F A2  JMP loc_A26F



tbl_A2E5:
- - - - - - 0x00C2F5 03:A2E5: EF A2     .word _off014_A2EF_00
- D 1 - - - 0x00C2F7 03:A2E7: EF A2     .word _off014_A2EF_02
- D 1 - - - 0x00C2F9 03:A2E9: EF A2     .word _off014_A2EF_04
- D 1 - - - 0x00C2FB 03:A2EB: FD A2     .word _off014_A2FD_06
- D 1 - - - 0x00C2FD 03:A2ED: EF A2     .word _off014_A2EF_08
...
sub_A31F:
C - - - - - 0x00C32F 03:A31F: A5 18     LDA ram_0018
...
C - - - - - 0x00C33F 03:A32F: B1 0E     LDA (ram_000E),Y
C - - - - - 0x00C341 03:A331: 18        CLC
C - - - - - 0x00C342 03:A332: 65 18     ADC ram_0018
C - - - - - 0x00C344 03:A334: A8        TAY
C - - - - - 0x00C345 03:A335: E6 09     INC ram_0009
C - - - - - 0x00C347 03:A337: B1 08     LDA (ram_0008),Y
C - - - - - 0x00C349 03:A339: C6 09     DEC ram_0009
C - - - - - 0x00C34B 03:A33B: 4C 46 A3  JMP loc_A346
bra_A33E:
C - - - - - 0x00C34E 03:A33E: B1 0E     LDA (ram_000E),Y
C - - - - - 0x00C350 03:A340: 18        CLC
C - - - - - 0x00C351 03:A341: 65 18     ADC ram_0018
C - - - - - 0x00C353 03:A343: A8        TAY
C - - - - - 0x00C354 03:A344: B1 08     LDA (ram_0008),Y
loc_A346:
C D 1 - - - 0x00C356 03:A346: 0A        ASL
C - - - - - 0x00C357 03:A347: A8        TAY
C - - - - - 0x00C358 03:A348: B1 1E     LDA (ram_001E),Y
C - - - - - 0x00C35A 03:A34A: 85 0A     STA ram_000A
C - - - - - 0x00C35C 03:A34C: C8        INY
C - - - - - 0x00C35D 03:A34D: B1 1E     LDA (ram_001E),Y
C - - - - - 0x00C35F 03:A34F: 85 0B     STA ram_000B
...
C - - - - - 0x00C367 03:A357: 85 1E     STA ram_001E
C - - - - - 0x00C369 03:A359: B9 74 A6  LDA tbl_A673 + 1,Y
C - - - - - 0x00C36C 03:A35C: 85 1F     STA ram_001F
sub_A35E:
C - - - - - 0x00C36E 03:A35E: A4 88     LDY ram_x2_stage
C - - - - - 0x00C370 03:A360: B9 69 A6  LDA tbl_A669,Y
C - - - - - 0x00C373 03:A363: 85 08     STA ram_0008
C - - - - - 0x00C375 03:A365: B9 6A A6  LDA tbl_A669 + 1,Y
C - - - - - 0x00C378 03:A368: 85 09     STA ram_0009
...
loc_A36B:
sub_A36B:
C D 1 - - - 0x00C37B 03:A36B: B1 0A     LDA (ram_000A),Y
C - - - - - 0x00C37D 03:A36D: 85 1C     STA ram_001C
C - - - - - 0x00C37F 03:A36F: C8        INY
C - - - - - 0x00C380 03:A370: B1 0A     LDA (ram_000A),Y
C - - - - - 0x00C382 03:A372: 85 0D     STA ram_000D
C - - - - - 0x00C384 03:A374: 84 06     STY ram_0006
C - - - - - 0x00C386 03:A376: 29 07     AND #$07
C - - - - - 0x00C388 03:A378: 18        CLC
C - - - - - 0x00C389 03:A379: 69 02     ADC #$02
C - - - - - 0x00C38B 03:A37B: A8        TAY
C - - - - - 0x00C38C 03:A37C: 84 07     STY ram_0007
C - - - - - 0x00C38E 03:A37E: A5 1C     LDA ram_001C
...
C - - - - - 0x00C3E8 03:A3D8: B9 7B A5  LDA tbl_A57B,Y
C - - - - - 0x00C3EB 03:A3DB: 48        PHA
C - - - - - 0x00C3EC 03:A3DC: B9 7D A5  LDA tbl_A57D,Y
C - - - - - 0x00C3EF 03:A3DF: 85 10     STA ram_0010
C - - - - - 0x00C3F1 03:A3E1: B9 7C A5  LDA tbl_A57C,Y
C - - - - - 0x00C3F4 03:A3E4: A4 07     LDY ram_0007
...
C - - - - - 0x00C47B 03:A46B: C8        INY
C - - - - - 0x00C47C 03:A46C: B1 0A     LDA (ram_000A),Y
...
bra_A49B:
C - - - - - 0x00C4AB 03:A49B: A5 10     LDA ram_0010
C - - - - - 0x00C4AD 03:A49D: 0A        ASL
C - - - - - 0x00C4AE 03:A49E: A8        TAY
C - - - - - 0x00C4AF 03:A49F: B9 64 A5  LDA tbl_A564,Y
C - - - - - 0x00C4B2 03:A4A2: 85 7B     STA ram_chr_bank + 4
C - - - - - 0x00C4B4 03:A4A4: B9 65 A5  LDA tbl_A564 + 1,Y
...
- D 1 - - - 0x00C4E9 03:A4D9: 00        .byte $00   ; 10
- D 1 - - - 0x00C4EA 03:A4DA: 00        .byte $00   ; 11
- - - - - - 0x00C4EB 03:A4DB: 00        .byte $00   ; 12
- D 1 - - - 0x00C4EC 03:A4DC: 11        .byte con_chr_bank + $11   ; 13
- D 1 - - - 0x00C4ED 03:A4DD: 1C        .byte con_chr_bank + $1C   ; 14
- - - - - - 0x00C4EE 03:A4DE: 0E        .byte con_chr_bank + $0E   ; 15
- - - - - - 0x00C4EF 03:A4DF: 00        .byte $00   ; 16
- D 1 - - - 0x00C4F0 03:A4E0: 4A        .byte con_chr_bank + $4A   ; 17
- - - - - - 0x00C4F1 03:A4E1: 26        .byte con_chr_bank + $26   ; 18
- D 1 - - - 0x00C4F2 03:A4E2: 26        .byte con_chr_bank + $26   ; 19
- D 1 - - - 0x00C4F3 03:A4E3: 00        .byte $00   ; 1A
- D 1 - - - 0x00C4F4 03:A4E4: 00        .byte $00   ; 1B
- - - - - - 0x00C4F5 03:A4E5: 00        .byte $00   ; 1C
- - - - - - 0x00C4F6 03:A4E6: 00        .byte $00   ; 1D
...
tbl_A57A:
- D 1 - - - 0x00C58A 03:A57A: 02        .byte $02   ; 
tbl_A57B:
- D 1 - - - 0x00C58B 03:A57B: 00        .byte $00   ; 
tbl_A57C:
- D 1 - - - 0x00C58C 03:A57C: 00        .byte $00   ; 
tbl_A57D:
- D 1 - - - 0x00C58D 03:A57D: 00        .byte $00   ; 
- D 1 - - - 0x00C58E 03:A57E: 02        .byte $02   ; 
- D 1 - - - 0x00C58F 03:A57F: 00        .byte $00   ; 
- D 1 - - - 0x00C590 03:A580: 01        .byte $01   ; 
- D 1 - - - 0x00C591 03:A581: 00        .byte $00   ; 
- D 1 - - - 0x00C592 03:A582: 02        .byte $02   ; 
- D 1 - - - 0x00C593 03:A583: 00        .byte $00   ; 
- D 1 - - - 0x00C594 03:A584: 02        .byte $02   ; 
- D 1 - - - 0x00C595 03:A585: 00        .byte $00   ; 
- D 1 - - - 0x00C596 03:A586: 02        .byte $02   ; 
- D 1 - - - 0x00C597 03:A587: 01        .byte $01   ; 
- D 1 - - - 0x00C598 03:A588: 02        .byte $02   ; 
- D 1 - - - 0x00C599 03:A589: 00        .byte $00   ; 
- D 1 - - - 0x00C59A 03:A58A: 03        .byte $03   ; 
- D 1 - - - 0x00C59B 03:A58B: 01        .byte $01   ; 
- D 1 - - - 0x00C59C 03:A58C: 00        .byte $00   ; 
- D 1 - - - 0x00C59D 03:A58D: 00        .byte $00   ; 
- D 1 - - - 0x00C59E 03:A58E: 03        .byte $03   ; 
- D 1 - - - 0x00C59F 03:A58F: 02        .byte $02   ; 
- D 1 - - - 0x00C5A0 03:A590: 01        .byte $01   ; 
- D 1 - - - 0x00C5A1 03:A591: 00        .byte $00   ; 
- D 1 - - - 0x00C5A2 03:A592: 02        .byte $02   ; 
- D 1 - - - 0x00C5A3 03:A593: 02        .byte $02   ; 
- D 1 - - - 0x00C5A4 03:A594: 01        .byte $01   ; 
- D 1 - - - 0x00C5A5 03:A595: 00        .byte $00   ; 
- D 1 - - - 0x00C5A6 03:A596: 02        .byte $02   ; 
- D 1 - - - 0x00C5A7 03:A597: 02        .byte $02   ; 
- D 1 - - - 0x00C5A8 03:A598: 02        .byte $02   ; 
- D 1 - - - 0x00C5A9 03:A599: 00        .byte $00   ; 
- D 1 - - - 0x00C5AA 03:A59A: 02        .byte $02   ; 
- D 1 - - - 0x00C5AB 03:A59B: 05        .byte $05   ; 
- D 1 - - - 0x00C5AC 03:A59C: 01        .byte $01   ; 
- D 1 - - - 0x00C5AD 03:A59D: 01        .byte $01   ; 
- D 1 - - - 0x00C5AE 03:A59E: 02        .byte $02   ; 
- D 1 - - - 0x00C5AF 03:A59F: 05        .byte $05   ; 
- D 1 - - - 0x00C5B0 03:A5A0: 02        .byte $02   ; 
- D 1 - - - 0x00C5B1 03:A5A1: 01        .byte $01   ; 
- D 1 - - - 0x00C5B2 03:A5A2: 02        .byte $02   ; 
- D 1 - - - 0x00C5B3 03:A5A3: 05        .byte $05   ; 
- D 1 - - - 0x00C5B4 03:A5A4: 01        .byte $01   ; 
- D 1 - - - 0x00C5B5 03:A5A5: 02        .byte $02   ; 
- D 1 - - - 0x00C5B6 03:A5A6: 02        .byte $02   ; 
- D 1 - - - 0x00C5B7 03:A5A7: 05        .byte $05   ; 
- D 1 - - - 0x00C5B8 03:A5A8: 02        .byte $02   ; 
- D 1 - - - 0x00C5B9 03:A5A9: 02        .byte $02   ; 
- - - - - - 0x00C5BA 03:A5AA: 02        .byte $02   ; 
- - - - - - 0x00C5BB 03:A5AB: 05        .byte $05   ; 
- - - - - - 0x00C5BC 03:A5AC: 01        .byte $01   ; 
- - - - - - 0x00C5BD 03:A5AD: 03        .byte $03   ; 
- D 1 - - - 0x00C5BE 03:A5AE: 02        .byte $02   ; 
- D 1 - - - 0x00C5BF 03:A5AF: 05        .byte $05   ; 
- D 1 - - - 0x00C5C0 03:A5B0: 02        .byte $02   ; 
- D 1 - - - 0x00C5C1 03:A5B1: 03        .byte $03   ; 
- D 1 - - - 0x00C5C2 03:A5B2: 03        .byte $03   ; 
- D 1 - - - 0x00C5C3 03:A5B3: 03        .byte $03   ; 
- D 1 - - - 0x00C5C4 03:A5B4: 01        .byte $01   ; 
- D 1 - - - 0x00C5C5 03:A5B5: 04        .byte $04   ; 
- - - - - - 0x00C5C6 03:A5B6: 03        .byte $03   ; 
- - - - - - 0x00C5C7 03:A5B7: 03        .byte $03   ; 
- - - - - - 0x00C5C8 03:A5B8: 02        .byte $02   ; 
- - - - - - 0x00C5C9 03:A5B9: 04        .byte $04   ; 
- D 1 - - - 0x00C5CA 03:A5BA: 02        .byte $02   ; 
- D 1 - - - 0x00C5CB 03:A5BB: 04        .byte $04   ; 
- D 1 - - - 0x00C5CC 03:A5BC: 02        .byte $02   ; 
- D 1 - - - 0x00C5CD 03:A5BD: 04        .byte $04   ; 
- - - - - - 0x00C5CE 03:A5BE: 03        .byte $03   ; 
- - - - - - 0x00C5CF 03:A5BF: 04        .byte $04   ; 
- - - - - - 0x00C5D0 03:A5C0: 01        .byte $01   ; 
- - - - - - 0x00C5D1 03:A5C1: 04        .byte $04   ; 
- - - - - - 0x00C5D2 03:A5C2: 02        .byte $02   ; 
- - - - - - 0x00C5D3 03:A5C3: 04        .byte $04   ; 
- - - - - - 0x00C5D4 03:A5C4: 02        .byte $02   ; 
- - - - - - 0x00C5D5 03:A5C5: 05        .byte $05   ; 
- D 1 - - - 0x00C5D6 03:A5C6: 03        .byte $03   ; 
- D 1 - - - 0x00C5D7 03:A5C7: 04        .byte $04   ; 
- D 1 - - - 0x00C5D8 03:A5C8: 01        .byte $01   ; 
- D 1 - - - 0x00C5D9 03:A5C9: 05        .byte $05   ; 
- D 1 - - - 0x00C5DA 03:A5CA: 05        .byte $05   ; 
- D 1 - - - 0x00C5DB 03:A5CB: 06        .byte $06   ; 
- D 1 - - - 0x00C5DC 03:A5CC: 00        .byte $00   ; 
- D 1 - - - 0x00C5DD 03:A5CD: 06        .byte $06   ; 
- D 1 - - - 0x00C5DE 03:A5CE: 05        .byte $05   ; 
- D 1 - - - 0x00C5DF 03:A5CF: 06        .byte $06   ; 
- D 1 - - - 0x00C5E0 03:A5D0: 01        .byte $01   ; 
- D 1 - - - 0x00C5E1 03:A5D1: 06        .byte $06   ; 
- - - - - - 0x00C5E2 03:A5D2: 05        .byte $05   ; 
- - - - - - 0x00C5E3 03:A5D3: 06        .byte $06   ; 
- - - - - - 0x00C5E4 03:A5D4: 00        .byte $00   ; 
- - - - - - 0x00C5E5 03:A5D5: 07        .byte $07   ; 
- - - - - - 0x00C5E6 03:A5D6: 05        .byte $05   ; 
- - - - - - 0x00C5E7 03:A5D7: 06        .byte $06   ; 
- - - - - - 0x00C5E8 03:A5D8: 01        .byte $01   ; 
- - - - - - 0x00C5E9 03:A5D9: 07        .byte $07   ; 
- D 1 - - - 0x00C5EA 03:A5DA: 05        .byte $05   ; 
- D 1 - - - 0x00C5EB 03:A5DB: 06        .byte $06   ; 
- D 1 - - - 0x00C5EC 03:A5DC: 00        .byte $00   ; 
- D 1 - - - 0x00C5ED 03:A5DD: 08        .byte $08   ; 
- - - - - - 0x00C5EE 03:A5DE: 05        .byte $05   ; 
- - - - - - 0x00C5EF 03:A5DF: 06        .byte $06   ; 
- - - - - - 0x00C5F0 03:A5E0: 01        .byte $01   ; 
- - - - - - 0x00C5F1 03:A5E1: 08        .byte $08   ; 
- D 1 - - - 0x00C5F2 03:A5E2: 05        .byte $05   ; 
- D 1 - - - 0x00C5F3 03:A5E3: 06        .byte $06   ; 
- D 1 - - - 0x00C5F4 03:A5E4: 05        .byte $05   ; 
- D 1 - - - 0x00C5F5 03:A5E5: 08        .byte $08   ; 
- D 1 - - - 0x00C5F6 03:A5E6: 06        .byte $06   ; 
- D 1 - - - 0x00C5F7 03:A5E7: 08        .byte $08   ; 
- D 1 - - - 0x00C5F8 03:A5E8: 00        .byte $00   ; 
- D 1 - - - 0x00C5F9 03:A5E9: 06        .byte $06   ; 
- D 1 - - - 0x00C5FA 03:A5EA: 05        .byte $05   ; 
- D 1 - - - 0x00C5FB 03:A5EB: 08        .byte $08   ; 
- D 1 - - - 0x00C5FC 03:A5EC: 04        .byte $04   ; 
- D 1 - - - 0x00C5FD 03:A5ED: 06        .byte $06   ; 
- D 1 - - - 0x00C5FE 03:A5EE: 06        .byte $06   ; 
- D 1 - - - 0x00C5FF 03:A5EF: 08        .byte $08   ; 
- D 1 - - - 0x00C600 03:A5F0: 04        .byte $04   ; 
- D 1 - - - 0x00C601 03:A5F1: 06        .byte $06   ; 
- D 1 - - - 0x00C602 03:A5F2: 05        .byte $05   ; 
- D 1 - - - 0x00C603 03:A5F3: 07        .byte $07   ; 
- D 1 - - - 0x00C604 03:A5F4: 04        .byte $04   ; 
- D 1 - - - 0x00C605 03:A5F5: 09        .byte $09   ; 
- D 1 - - - 0x00C606 03:A5F6: 05        .byte $05   ; 
- D 1 - - - 0x00C607 03:A5F7: 07        .byte $07   ; 
- D 1 - - - 0x00C608 03:A5F8: 02        .byte $02   ; 
- D 1 - - - 0x00C609 03:A5F9: 09        .byte $09   ; 
- D 1 - - - 0x00C60A 03:A5FA: 05        .byte $05   ; 
- D 1 - - - 0x00C60B 03:A5FB: 07        .byte $07   ; 
- D 1 - - - 0x00C60C 03:A5FC: 03        .byte $03   ; 
- D 1 - - - 0x00C60D 03:A5FD: 09        .byte $09   ; 
- D 1 - - - 0x00C60E 03:A5FE: 05        .byte $05   ; 
- D 1 - - - 0x00C60F 03:A5FF: 07        .byte $07   ; 
- D 1 - - - 0x00C610 03:A600: 01        .byte $01   ; 
- D 1 - - - 0x00C611 03:A601: 09        .byte $09   ; 
- D 1 - - - 0x00C612 03:A602: 06        .byte $06   ; 
- D 1 - - - 0x00C613 03:A603: 07        .byte $07   ; 
- D 1 - - - 0x00C614 03:A604: 04        .byte $04   ; 
- D 1 - - - 0x00C615 03:A605: 09        .byte $09   ; 
- D 1 - - - 0x00C616 03:A606: 06        .byte $06   ; 
- D 1 - - - 0x00C617 03:A607: 07        .byte $07   ; 
- D 1 - - - 0x00C618 03:A608: 05        .byte $05   ; 
- D 1 - - - 0x00C619 03:A609: 09        .byte $09   ; 
- D 1 - - - 0x00C61A 03:A60A: 06        .byte $06   ; 
- D 1 - - - 0x00C61B 03:A60B: 07        .byte $07   ; 
- D 1 - - - 0x00C61C 03:A60C: 01        .byte $01   ; 
- D 1 - - - 0x00C61D 03:A60D: 0A        .byte $0A   ; 
- D 1 - - - 0x00C61E 03:A60E: 06        .byte $06   ; 
- D 1 - - - 0x00C61F 03:A60F: 07        .byte $07   ; 
- D 1 - - - 0x00C620 03:A610: 02        .byte $02   ; 
- D 1 - - - 0x00C621 03:A611: 0A        .byte $0A   ; 
- D 1 - - - 0x00C622 03:A612: 05        .byte $05   ; 
- D 1 - - - 0x00C623 03:A613: 07        .byte $07   ; 
- D 1 - - - 0x00C624 03:A614: 04        .byte $04   ; 
- D 1 - - - 0x00C625 03:A615: 0A        .byte $0A   ; 
- D 1 - - - 0x00C626 03:A616: 06        .byte $06   ; 
- D 1 - - - 0x00C627 03:A617: 07        .byte $07   ; 
- D 1 - - - 0x00C628 03:A618: 04        .byte $04   ; 
- D 1 - - - 0x00C629 03:A619: 0A        .byte $0A   ; 
tbl_A61A:
- D 1 - - - 0x00C62A 03:A61A: 01        .byte $01   ; 
- D 1 - - - 0x00C62B 03:A61B: 11        .byte $11   ; 
- D 1 - - - 0x00C62C 03:A61C: D1        .byte $D1   ; 
- D 1 - - - 0x00C62D 03:A61D: B1        .byte $B1   ; 
- D 1 - - - 0x00C62E 03:A61E: 31        .byte $31   ; 
- D 1 - - - 0x00C62F 03:A61F: 21        .byte $21   ; 
- D 1 - - - 0x00C630 03:A620: 41        .byte $41   ; 
tbl_A621:
- D 1 - - - 0x00C631 03:A621: 00        .byte $00   ; 
- - - - - - 0x00C632 03:A622: 00        .byte $00   ; 
- D 1 - - - 0x00C633 03:A623: 02        .byte $02   ; 
- - - - - - 0x00C634 03:A624: 00        .byte $00   ; 
- - - - - - 0x00C635 03:A625: 00        .byte $00   ; 
- - - - - - 0x00C636 03:A626: 00        .byte $00   ; 
- - - - - - 0x00C637 03:A627: 00        .byte $00   ; 
- - - - - - 0x00C638 03:A628: 00        .byte $00   ; 
- - - - - - 0x00C639 03:A629: 00        .byte $00   ; 
- D 1 - - - 0x00C63A 03:A62A: 00        .byte $00   ; 
- - - - - - 0x00C63B 03:A62B: 00        .byte $00   ; 
- - - - - - 0x00C63C 03:A62C: 00        .byte $00   ; 
- - - - - - 0x00C63D 03:A62D: 00        .byte $00   ; 
- - - - - - 0x00C63E 03:A62E: 00        .byte $00   ; 
- - - - - - 0x00C63F 03:A62F: 00        .byte $00   ; 
- - - - - - 0x00C640 03:A630: 00        .byte $00   ; 
- - - - - - 0x00C641 03:A631: 00        .byte $00   ; 
- - - - - - 0x00C642 03:A632: 00        .byte $00   ; 
- - - - - - 0x00C643 03:A633: 01        .byte $01   ; 
- - - - - - 0x00C644 03:A634: 01        .byte $01   ; 
- D 1 - - - 0x00C645 03:A635: 00        .byte $00   ; 
- D 1 - - - 0x00C646 03:A636: 00        .byte $00   ; 
- D 1 - - - 0x00C647 03:A637: 01        .byte $01   ; 
- - - - - - 0x00C648 03:A638: 00        .byte $00   ; 
- - - - - - 0x00C649 03:A639: 01        .byte $01   ; 
- - - - - - 0x00C64A 03:A63A: 00        .byte $00   ; 
- D 1 - - - 0x00C64B 03:A63B: 00        .byte $00   ; 
- - - - - - 0x00C64C 03:A63C: 00        .byte $00   ; 
- - - - - - 0x00C64D 03:A63D: 00        .byte $00   ; 
- - - - - - 0x00C64E 03:A63E: 00        .byte $00   ; 
- - - - - - 0x00C64F 03:A63F: 00        .byte $00   ; 
- - - - - - 0x00C650 03:A640: 00        .byte $00   ; 
- - - - - - 0x00C651 03:A641: 02        .byte $02   ; 
- - - - - - 0x00C652 03:A642: 00        .byte $00   ; 
- - - - - - 0x00C653 03:A643: 00        .byte $00   ; 
- - - - - - 0x00C654 03:A644: 00        .byte $00   ; 
- - - - - - 0x00C655 03:A645: 02        .byte $02   ; 
- - - - - - 0x00C656 03:A646: 02        .byte $02   ; 
- D 1 - - - 0x00C657 03:A647: 00        .byte $00   ; 
- - - - - - 0x00C658 03:A648: 00        .byte $00   ; 
- D 1 - - - 0x00C659 03:A649: 00        .byte $00   ; 
- - - - - - 0x00C65A 03:A64A: 00        .byte $00   ; 
- - - - - - 0x00C65B 03:A64B: 02        .byte $02   ; 
- D 1 - - - 0x00C65C 03:A64C: 00        .byte $00   ; 
- D 1 - - - 0x00C65D 03:A64D: 00        .byte $00   ; 
- - - - - - 0x00C65E 03:A64E: 00        .byte $00   ; 
- - - - - - 0x00C65F 03:A64F: 02        .byte $02   ; 
- - - - - - 0x00C660 03:A650: 00        .byte $00   ; 
- D 1 - - - 0x00C661 03:A651: 00        .byte $00   ; 
- D 1 - - - 0x00C662 03:A652: 00        .byte $00   ; 
- - - - - - 0x00C663 03:A653: 02        .byte $02   ; 
- - - - - - 0x00C664 03:A654: 02        .byte $02   ; 
- D 1 - - - 0x00C665 03:A655: 02        .byte $02   ; 
- D 1 - - - 0x00C666 03:A656: 00        .byte $00   ; 
- D 1 - - - 0x00C667 03:A657: 02        .byte $02   ; 
- - - - - - 0x00C668 03:A658: 00        .byte $00   ; 
- D 1 - - - 0x00C669 03:A659: 00        .byte $00   ; 
- - - - - - 0x00C66A 03:A65A: 00        .byte $00   ; 
- D 1 - - - 0x00C66B 03:A65B: 01        .byte $01   ; 
- D 1 - - - 0x00C66C 03:A65C: 01        .byte $01   ; 
- D 1 - - - 0x00C66D 03:A65D: 01        .byte $01   ; 
- D 1 - - - 0x00C66E 03:A65E: 00        .byte $00   ; 
- D 1 - - - 0x00C66F 03:A65F: 01        .byte $01   ; 
- - - - - - 0x00C670 03:A660: 00        .byte $00   ; 
- D 1 - - - 0x00C671 03:A661: 01        .byte $01   ; 
- - - - - - 0x00C672 03:A662: 00        .byte $00   ; 
- D 1 - - - 0x00C673 03:A663: 00        .byte $00   ; 
- - - - - - 0x00C674 03:A664: 00        .byte $00   ; 
- D 1 - - - 0x00C675 03:A665: 01        .byte $01   ; 
- - - - - - 0x00C676 03:A666: 01        .byte $01   ; 
- D 1 - - - 0x00C677 03:A667: 00        .byte $00   ; 
- - - - - - 0x00C678 03:A668: 00        .byte $00   ; 



tbl_A669:
- D 1 - - - 0x00C679 03:A669: 7D A6     .word _off015_A67D_00
- D 1 - - - 0x00C67B 03:A66B: 00 A8     .word _off015_A800_02
- D 1 - - - 0x00C67D 03:A66D: 6E A9     .word _off015_A96E_04
- D 1 - - - 0x00C67F 03:A66F: 61 AA     .word _off015_AA61_06
- D 1 - - - 0x00C681 03:A671: 15 AE     .word _off015_AE15_08



tbl_A673:
- - - - - - 0x00C683 03:A673: 41 A8     .word _off016_A841_00
- D 1 - - - 0x00C685 03:A675: 41 A8     .word _off016_A841_02
- D 1 - - - 0x00C687 03:A677: 91 A9     .word _off016_A991_04
- D 1 - - - 0x00C689 03:A679: ED AB     .word _off016_ABED_06
- D 1 - - - 0x00C68B 03:A67B: 33 AE     .word _off016_AE33_08
...
_off016_A841_00:
_off016_A841_02:
- D 1 - I - 0x00C851 03:A841: 7D A8     .word _off018_02_A87D_00
- D 1 - I - 0x00C853 03:A843: 6D A8     .word _off018_02_A86D_01
- D 1 - I - 0x00C855 03:A845: 7E A8     .word _off018_02_A87E_02
- D 1 - I - 0x00C857 03:A847: 8B A8     .word _off018_02_A88B_03
- D 1 - I - 0x00C859 03:A849: 98 A8     .word _off018_02_A898_04
- D 1 - I - 0x00C85B 03:A84B: A9 A8     .word _off018_02_A8A9_05
- D 1 - I - 0x00C85D 03:A84D: BE A8     .word _off018_02_A8BE_06
- D 1 - I - 0x00C85F 03:A84F: C3 A8     .word _off018_02_A8C3_07
- D 1 - I - 0x00C861 03:A851: D0 A8     .word _off018_02_A8D0_08
- D 1 - I - 0x00C863 03:A853: E1 A8     .word _off018_02_A8E1_09
- D 1 - I - 0x00C865 03:A855: E6 A8     .word _off018_02_A8E6_0A
- D 1 - I - 0x00C867 03:A857: EB A8     .word _off018_02_A8EB_0B
- D 1 - I - 0x00C869 03:A859: F8 A8     .word _off018_02_A8F8_0C
- D 1 - I - 0x00C86B 03:A85B: 0B A9     .word _off018_02_A90B_0D
- D 1 - I - 0x00C86D 03:A85D: 1C A9     .word _off018_02_A91C_0E
- D 1 - I - 0x00C86F 03:A85F: 2D A9     .word _off018_02_A92D_0F
- D 1 - I - 0x00C871 03:A861: 46 A9     .word _off018_02_A946_10
- D 1 - I - 0x00C873 03:A863: 5B A9     .word _off018_02_A95B_11
- D 1 - I - 0x00C875 03:A865: 60 A9     .word _off018_02_A960_12
- D 1 - I - 0x00C877 03:A867: 65 A9     .word _off018_02_A965_13
- D 1 - I - 0x00C879 03:A869: 05 A9     .word _off018_02_A905_14
- - - - - - 0x00C87B 03:A86B: 0A A9     .word _off018_02_A90A_15
...
_off016_A991_04:
- D 1 - I - 0x00C9A1 03:A991: BB A9     .word _off018_04_A9BB_00
- D 1 - I - 0x00C9A3 03:A993: B7 A9     .word _off018_04_A9B7_01
- D 1 - I - 0x00C9A5 03:A995: BC A9     .word _off018_04_A9BC_02
- D 1 - I - 0x00C9A7 03:A997: C3 A9     .word _off018_04_A9C3_03
- D 1 - I - 0x00C9A9 03:A999: C4 A9     .word _off018_04_A9C4_04
- D 1 - I - 0x00C9AB 03:A99B: CD A9     .word _off018_04_A9CD_05
- D 1 - I - 0x00C9AD 03:A99D: DA A9     .word _off018_04_A9DA_06
- D 1 - I - 0x00C9AF 03:A99F: E7 A9     .word _off018_04_A9E7_07
- D 1 - I - 0x00C9B1 03:A9A1: F0 A9     .word _off018_04_A9F0_08
- D 1 - I - 0x00C9B3 03:A9A3: F9 A9     .word _off018_04_A9F9_09
- D 1 - I - 0x00C9B5 03:A9A5: FA A9     .word _off018_04_A9FA_0A
- D 1 - I - 0x00C9B7 03:A9A7: 03 AA     .word _off018_04_AA03_0B
- D 1 - I - 0x00C9B9 03:A9A9: 19 AA     .word _off018_04_AA19_0C
- D 1 - I - 0x00C9BB 03:A9AB: 2E AA     .word _off018_04_AA2E_0D
- D 1 - I - 0x00C9BD 03:A9AD: 3B AA     .word _off018_04_AA3B_0E
- D 1 - I - 0x00C9BF 03:A9AF: 4C AA     .word _off018_04_AA4C_0F
- D 1 - I - 0x00C9C1 03:A9B1: C1 A9     .word _off018_04_A9C1_10
- D 1 - I - 0x00C9C3 03:A9B3: 10 AA     .word _off018_04_AA10_11
- - - - - - 0x00C9C5 03:A9B5: C2 A9     .word _off018_04_A9C2_12
...
_off016_ABED_06:
- D 1 - I - 0x00CBFD 03:ABED: 57 AC     .word _off018_06_AC57_00
- D 1 - I - 0x00CBFF 03:ABEF: 58 AC     .word _off018_06_AC58_01
- D 1 - I - 0x00CC01 03:ABF1: 1C AD     .word _off018_06_AD1C_02
- D 1 - I - 0x00CC03 03:ABF3: 5D AC     .word _off018_06_AC5D_03
- D 1 - I - 0x00CC05 03:ABF5: 62 AC     .word _off018_06_AC62_04
- D 1 - I - 0x00CC07 03:ABF7: 67 AC     .word _off018_06_AC67_05
- D 1 - I - 0x00CC09 03:ABF9: 6C AC     .word _off018_06_AC6C_06
- D 1 - I - 0x00CC0B 03:ABFB: 7D AC     .word _off018_06_AC7D_07
- D 1 - I - 0x00CC0D 03:ABFD: CE AD     .word _off018_06_ADCE_08
- D 1 - I - 0x00CC0F 03:ABFF: 82 AC     .word _off018_06_AC82_09
- D 1 - I - 0x00CC11 03:AC01: 8B AC     .word _off018_06_AC8B_0A
- D 1 - I - 0x00CC13 03:AC03: 98 AC     .word _off018_06_AC98_0B
- D 1 - I - 0x00CC15 03:AC05: 10 AE     .word _off018_06_AE10_0C
- D 1 - I - 0x00CC17 03:AC07: 9D AC     .word _off018_06_AC9D_0D
- D 1 - I - 0x00CC19 03:AC09: AA AC     .word _off018_06_ACAA_0E
- D 1 - I - 0x00CC1B 03:AC0B: B3 AC     .word _off018_06_ACB3_0F
- D 1 - I - 0x00CC1D 03:AC0D: B8 AC     .word _off018_06_ACB8_10
- D 1 - I - 0x00CC1F 03:AC0F: C9 AC     .word _off018_06_ACC9_11
- D 1 - I - 0x00CC21 03:AC11: D2 AC     .word _off018_06_ACD2_12
- D 1 - I - 0x00CC23 03:AC13: DF AC     .word _off018_06_ACDF_13
- D 1 - I - 0x00CC25 03:AC15: 01 AD     .word _off018_06_AD01_14
- D 1 - I - 0x00CC27 03:AC17: 06 AD     .word _off018_06_AD06_15
- D 1 - I - 0x00CC29 03:AC19: 17 AD     .word _off018_06_AD17_16
- D 1 - I - 0x00CC2B 03:AC1B: FC AC     .word _off018_06_ACFC_17
- D 1 - I - 0x00CC2D 03:AC1D: 31 AD     .word _off018_06_AD31_18
- D 1 - I - 0x00CC2F 03:AC1F: 36 AD     .word _off018_06_AD36_19
- D 1 - I - 0x00CC31 03:AC21: 3B AD     .word _off018_06_AD3B_1A
- D 1 - I - 0x00CC33 03:AC23: 48 AD     .word _off018_06_AD48_1B
- D 1 - I - 0x00CC35 03:AC25: 61 AD     .word _off018_06_AD61_1C
- D 1 - I - 0x00CC37 03:AC27: 66 AD     .word _off018_06_AD66_1D
- - - - - - 0x00CC39 03:AC29: 6F AD     .word _off018_06_AD6F_1E
- D 1 - I - 0x00CC3B 03:AC2B: 4B AC     .word _off018_06_AC4B_1F
- D 1 - I - 0x00CC3D 03:AC2D: 78 AD     .word _off018_06_AD78_20
- D 1 - I - 0x00CC3F 03:AC2F: 81 AD     .word _off018_06_AD81_21
- D 1 - I - 0x00CC41 03:AC31: 8A AD     .word _off018_06_AD8A_22
- D 1 - I - 0x00CC43 03:AC33: 93 AD     .word _off018_06_AD93_23
- D 1 - I - 0x00CC45 03:AC35: A0 AD     .word _off018_06_ADA0_24
- D 1 - I - 0x00CC47 03:AC37: AD AD     .word _off018_06_ADAD_25
- D 1 - I - 0x00CC49 03:AC39: B6 AD     .word _off018_06_ADB6_26
- D 1 - I - 0x00CC4B 03:AC3B: BB AD     .word _off018_06_ADBB_27
- D 1 - I - 0x00CC4D 03:AC3D: C0 AD     .word _off018_06_ADC0_28
- D 1 - I - 0x00CC4F 03:AC3F: C9 AD     .word _off018_06_ADC9_29
- D 1 - I - 0x00CC51 03:AC41: D3 AD     .word _off018_06_ADD3_2A
- D 1 - I - 0x00CC53 03:AC43: D8 AD     .word _off018_06_ADD8_2B
- D 1 - I - 0x00CC55 03:AC45: F1 AD     .word _off018_06_ADF1_2C
- D 1 - I - 0x00CC57 03:AC47: F6 AD     .word _off018_06_ADF6_2D
- D 1 - I - 0x00CC59 03:AC49: 07 AE     .word _off018_06_AE07_2E
...
_off016_AE33_08:
- D 1 - I - 0x00CE43 03:AE33: 63 AE     .word _off018_08_AE63_00
- D 1 - I - 0x00CE45 03:AE35: 63 AE     .word _off018_08_AE63_01
- D 1 - I - 0x00CE47 03:AE37: 53 AE     .word _off018_08_AE53_02
- D 1 - I - 0x00CE49 03:AE39: 64 AE     .word _off018_08_AE64_03
- D 1 - I - 0x00CE4B 03:AE3B: 75 AE     .word _off018_08_AE75_04
- D 1 - I - 0x00CE4D 03:AE3D: 86 AE     .word _off018_08_AE86_05
- D 1 - I - 0x00CE4F 03:AE3F: 8B AE     .word _off018_08_AE8B_06
- D 1 - I - 0x00CE51 03:AE41: 98 AE     .word _off018_08_AE98_07
- D 1 - I - 0x00CE53 03:AE43: A9 AE     .word _off018_08_AEA9_08
- D 1 - I - 0x00CE55 03:AE45: BE AE     .word _off018_08_AEBE_09
- D 1 - I - 0x00CE57 03:AE47: D3 AE     .word _off018_08_AED3_0A
- D 1 - I - 0x00CE59 03:AE49: E0 AE     .word _off018_08_AEE0_0B
- D 1 - I - 0x00CE5B 03:AE4B: E5 AE     .word _off018_08_AEE5_0C
- D 1 - I - 0x00CE5D 03:AE4D: FE AE     .word _off018_08_AEFE_0D
- D 1 - I - 0x00CE5F 03:AE4F: 07 AF     .word _off018_08_AF07_0E
- D 1 - I - 0x00CE61 03:AE51: 10 AF     .word _off018_08_AF10_0F
...
C - - - - - 0x00CFBB 03:AFAB: 85 00     STA ram_0000
C - - - - - 0x00CFBD 03:AFAD: B9 B6 AF  LDA tbl_AFB5 + 1,Y
C - - - - - 0x00CFC0 03:AFB0: 85 01     STA ram_0001
...
off_AFBB_00:
- D 1 - I - 0x00CFCB 03:AFBB: 48        .byte $48   ; 
- D 1 - I - 0x00CFCC 03:AFBC: 86        .byte $86   ; 
- D 1 - I - 0x00CFCD 03:AFBD: C1        .byte $C1   ; 
- D 1 - I - 0x00CFCE 03:AFBE: 01        .byte $01   ; 
- D 1 - I - 0x00CFCF 03:AFBF: 25        .byte $25   ; 
- D 1 - I - 0x00CFD0 03:AFC0: 85        .byte $85   ; 
- D 1 - I - 0x00CFD1 03:AFC1: 00        .byte $00   ; 
- D 1 - I - 0x00CFD2 03:AFC2: FE        .byte $FE   ; 



off_AFC3_01:
- D 1 - I - 0x00CFD3 03:AFC3: 08        .byte $08   ; 
- D 1 - I - 0x00CFD4 03:AFC4: 03        .byte $03   ; 
- D 1 - I - 0x00CFD5 03:AFC5: 81        .byte $81   ; 
- D 1 - I - 0x00CFD6 03:AFC6: 01        .byte $01   ; 
- D 1 - I - 0x00CFD7 03:AFC7: C0        .byte $C0   ; 
- D 1 - I - 0x00CFD8 03:AFC8: 02        .byte $02   ; 
- D 1 - I - 0x00CFD9 03:AFC9: 01        .byte $01   ; 
- D 1 - I - 0x00CFDA 03:AFCA: 00        .byte $00   ; 



off_AFCB_02:
- D 1 - I - 0x00CFDB 03:AFCB: 79        .byte $79   ; 
- D 1 - I - 0x00CFDC 03:AFCC: 85        .byte $85   ; 
- D 1 - I - 0x00CFDD 03:AFCD: C1        .byte $C1   ; 
- D 1 - I - 0x00CFDE 03:AFCE: 01        .byte $01   ; 
- D 1 - I - 0x00CFDF 03:AFCF: D6        .byte $D6   ; 
- D 1 - I - 0x00CFE0 03:AFD0: 84        .byte $84   ; 
- D 1 - I - 0x00CFE1 03:AFD1: 00        .byte $00   ; 
- D 1 - I - 0x00CFE2 03:AFD2: FE        .byte $FE   ; 
...
C - - - - - 0x00CFF7 03:AFE7: 85 18     STA ram_0018
C - - - - - 0x00CFF9 03:AFE9: B9 F2 AF  LDA tbl_AFF1 + 1,Y
C - - - - - 0x00CFFC 03:AFEC: 85 19     STA ram_0019
C - - - - - 0x00CFFE 03:AFEE: 6C 18 00  JMP (ram_0018)
...
C - - - - - 0x00D0D0 03:B0C0: B9 0D B1  LDA tbl_B10E - 1,Y
C - - - - - 0x00D0D3 03:B0C3: 18        CLC
C - - - - - 0x00D0D4 03:B0C4: 65 02     ADC ram_0002
C - - - - - 0x00D0D6 03:B0C6: 85 02     STA ram_0002
...
C - - - - - 0x00D1A8 03:B198: 85 00     STA ram_0000
C - - - - - 0x00D1AA 03:B19A: B9 A3 B1  LDA tbl_B1A2 + 1,Y
C - - - - - 0x00D1AD 03:B19D: 85 01     STA ram_0001
...
off_B1AA_00:
- - - - - - 0x00D1BA 03:B1AA: 00        .byte $00   ; 
- - - - - - 0x00D1BB 03:B1AB: 00        .byte $00   ; 
- - - - - - 0x00D1BC 03:B1AC: C3        .byte $C3   ; 
- - - - - - 0x00D1BD 03:B1AD: 01        .byte $01   ; 
- - - - - - 0x00D1BE 03:B1AE: 88        .byte $88   ; 
- - - - - - 0x00D1BF 03:B1AF: 81        .byte $81   ; 
- - - - - - 0x00D1C0 03:B1B0: E3        .byte $E3   ; 
- - - - - - 0x00D1C1 03:B1B1: 02        .byte $02   ; 
- - - - - - 0x00D1C2 03:B1B2: CB        .byte $CB   ; 
- - - - - - 0x00D1C3 03:B1B3: 00        .byte $00   ; 
- - - - - - 0x00D1C4 03:B1B4: C3        .byte $C3   ; 
- - - - - - 0x00D1C5 03:B1B5: 03        .byte $03   ; 
- - - - - - 0x00D1C6 03:B1B6: 7F        .byte $7F   ; 
- - - - - - 0x00D1C7 03:B1B7: 80        .byte $80   ; 
- - - - - - 0x00D1C8 03:B1B8: 00        .byte $00   ; 
- - - - - - 0x00D1C9 03:B1B9: FF        .byte $FF   ; 
...
off_B1BA_04:
off_B1BA_06:
- D 1 - I - 0x00D1CA 03:B1BA: 00        .byte $00   ; 
- D 1 - I - 0x00D1CB 03:B1BB: 00        .byte $00   ; 
- D 1 - I - 0x00D1CC 03:B1BC: A3        .byte $A3   ; 
- D 1 - I - 0x00D1CD 03:B1BD: 01        .byte $01   ; 
- D 1 - I - 0x00D1CE 03:B1BE: 7B        .byte $7B   ; 
- D 1 - I - 0x00D1CF 03:B1BF: 00        .byte $00   ; 
- D 1 - I - 0x00D1D0 03:B1C0: C3        .byte $C3   ; 
- D 1 - I - 0x00D1D1 03:B1C1: 02        .byte $02   ; 
- D 1 - I - 0x00D1D2 03:B1C2: 88        .byte $88   ; 
- D 1 - I - 0x00D1D3 03:B1C3: 81        .byte $81   ; 
- D 1 - I - 0x00D1D4 03:B1C4: E3        .byte $E3   ; 
- D 1 - I - 0x00D1D5 03:B1C5: 03        .byte $03   ; 
- D 1 - I - 0x00D1D6 03:B1C6: CB        .byte $CB   ; 
- D 1 - I - 0x00D1D7 03:B1C7: 00        .byte $00   ; 
- D 1 - I - 0x00D1D8 03:B1C8: C3        .byte $C3   ; 
- D 1 - I - 0x00D1D9 03:B1C9: 04        .byte $04   ; 
- D 1 - I - 0x00D1DA 03:B1CA: 7F        .byte $7F   ; 
- D 1 - I - 0x00D1DB 03:B1CB: 80        .byte $80   ; 
- D 1 - I - 0x00D1DC 03:B1CC: 00        .byte $00   ; 
- D 1 - I - 0x00D1DD 03:B1CD: FF        .byte $FF   ; 
...
C - - - - - 0x00D1E7 03:B1D7: A5 23     LDA ram_0023
...
tbl_B26D:
- D 1 - - - 0x00D27D 03:B26D: 87        .byte $87   ; 00
- - - - - - 0x00D27E 03:B26E: 00        .byte $00   ; 01
- D 1 - - - 0x00D27F 03:B26F: 71        .byte $71   ; 02
...
tbl_B298:
- - - - - - 0x00D2A8 03:B298: 97        .byte $97   ; 00
- - - - - - 0x00D2A9 03:B299: 00        .byte $00   ; 01
- - - - - - 0x00D2AA 03:B29A: 78        .byte $78   ; 02
