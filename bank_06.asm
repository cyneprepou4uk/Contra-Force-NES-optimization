...
C - - - - - 0x00C13F 03:A12F: F0 C4     BNE bra_A131    ; if was not FF
                                        RTS
bra_A131:
...
C - - - - - 0x00C0BF 03:A0AF: F0 44     BEQ bra_A0D8_RTS
bra_A0B1:
...
C - - - - - 0x00C0CB 03:A0BB: F0 38     BEQ bra_A0D8_RTS
C - - - - - 0x00C0CD 03:A0BD: A5 8C     LDA ram_008C
C - - - - - 0x00C0CF 03:A0BF: D0 34     BNE bra_A0D8_RTS
...
C - - - - - 0x00C1E7 03:A1D7: F0 DD     BNE bra_A1D9
                                        RTS
bra_A1D9:
