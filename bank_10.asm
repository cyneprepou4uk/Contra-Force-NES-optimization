...
- D 0 - I - 0x010443 04:8433: 00        .word _off000_CF00_A4_00
- D 0 - I - 0x010445 04:8435: 01        .byte $01   ; 
- D 0 - I - 0x010446 04:8436: 4C CF     .word _off000_CF4C_A4_01
- D 0 - I - 0x010448 04:8438: 02        .byte $02   ; 
- D 0 - I - 0x010449 04:8439: 9D CF     .word _off000_CF9D_A4_02
- D 0 - I - 0x01044B 04:843B: 03        .byte $03   ; 
- D 0 - I - 0x01044C 04:843C: CF CF     .word _off000_CFCF_A4_03
; A8 con_music_A8
...
C - - - - - 0x01057B 04:856B: BD 02 C0  LDA tbl_C001_for_4010_4013 + $01,X
C - - - - - 0x01057E 04:856E: A9 0F     LDA #$0F
C - - - - - 0x010580 04:8570: 8D 15 40  STA $4015
C - - - - - 0x010583 04:8573: BD 01 C0  LDA tbl_C001_for_4010_4013,X
C - - - - - 0x010586 04:8576: 8D 10 40  STA $4010
C - - - - - 0x010589 04:8579: BD 02 C0  LDA tbl_C001_for_4010_4013 + $01,X
C - - - - - 0x01058C 04:857C: 8D 11 40  STA $4011
C - - - - - 0x01058F 04:857F: BD 03 C0  LDA tbl_C001_for_4010_4013 + $02,X
C - - - - - 0x010592 04:8582: 8D 12 40  STA $4012
C - - - - - 0x010595 04:8585: BD 04 C0  LDA tbl_C001_for_4010_4013 + $03,X
...
tbl_C001_for_4010_4013:
;                                              +-------------------------- 4010
;                                              |    +--------------------- 4011
;                                              |    |    +---------------- 4012
;                                              |    |    |          +----- 4013
;                                              |    |    |          |
- D 2 - - - 0x01C011 07:C001: 0F        .byte $0F, $00, $00 + $45, $4C   ; AC 
- D 2 - - - 0x01C015 07:C005: 0F        .byte $0F, $00, $13 + $45, $4C   ; AD 
- D 2 - - - 0x01C019 07:C009: 0F        .byte $0F, $3F, $26 + $45, $28   ; AE 
- D 2 - - - 0x01C01D 07:C00D: 0F        .byte $0F, $00, $26 + $45, $28   ; AF 
- D 2 - - - 0x01C021 07:C011: 0D        .byte $0D, $4F, $30 + $45, $24   ; B0 
- D 2 - - - 0x01C025 07:C015: 0E        .byte $0E, $4F, $30 + $45, $24   ; B1 
- D 2 - - - 0x01C029 07:C019: 0F        .byte $0F, $4F, $30 + $45, $24   ; B2 
- D 2 - - - 0x01C02D 07:C01D: 0F        .byte $0F, $3F, $39 + $45, $08   ; B3 
