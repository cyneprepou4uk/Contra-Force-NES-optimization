...
bra_A149:
loc_A149:
C D 1 - - - 0x00A159 02:A149: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
...
C - - - - - 0x00A1C6 02:A1B6: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
...
C - - - - - 0x00A231 02:A221: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
...
bra_A23B:
C - - - - - 0x00A24B 02:A23B: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
...
C - - - - - 0x00A2C8 02:A2B8: 20 A8 A0  LDA ram_07AA_unk,X
                                        AND #$0F
                                        CMP #$05
...
C - - - - - 0x00A2DC 02:A2CC: 20 A8 A0  LDA ram_07AA_unk,X
                                        AND #$0F
                                        CMP #$05
...
C - - - - - 0x00A2EE 02:A2DE: 20 A8 A0  LDA ram_07AA_unk,X
                                        AND #$0F
                                        CMP #$05
...
C - - - - - 0x00A386 02:A376: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
...
bra_A61F_side_view:
C - - - - - 0x00A62F 02:A61F: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
...
; if side view
C - - - - - 0x00A708 02:A6F8: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
...
C - - - - - 0x00A720 02:A710: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
...
bra_A726:
C - - - - - 0x00A736 02:A726: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
...
bra_A739_upper_view:
C - - - - - 0x00A749 02:A739: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
...
bra_A7A7_side_view:
C - - - - - 0x00A7B7 02:A7A7: 20 A8 A0  LDA ram_07AA_unk,X
                                        AND #$0F
                                        CMP #$05
...
; if side view
C - - - - - 0x00A7E0 02:A7D0: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
C - - - - - 0x00A7E3 02:A7D3: D0 09     BNE bra_A7DE
C - - - - - 0x00A7E5 02:A7D5: 20 A8 A0  LDA ram_07AA_unk,X
                                        AND #$0F
                                        CMP #$05
...
C - - - - - 0x00A807 02:A7F7: 20 A8 A0  LDA ram_07AA_unk,X
                                        AND #$0F
                                        CMP #$05
...
C - - - - - 0x00A814 02:A804: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
...
C - - - - - 0x00A884 02:A874: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
...
C - - - - - 0x00A8BA 02:A8AA: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
...
; if upper view
C - - - - - 0x00AD0D 02:ACFD: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
...
bra_AD0A_side_view:
C - - - - - 0x00AD1A 02:AD0A: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
C - - - - - 0x00AD1D 02:AD0D: D0 1F     BNE bra_AD2E
C - - - - - 0x00AD1F 02:AD0F: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
...
bra_AD2E:
C - - - - - 0x00AD3E 02:AD2E: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
...
C - - - - - 0x00AD6E 02:AD5E: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
...
; if side view
C - - - - - 0x00ADCC 02:ADBC: 20 A4 A1  LDA ram_07AA_unk,X
                                        AND #$40
...
C - - - - - 0x00B0BC 02:B0AC: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
...
C - - - - - 0x00B110 02:B100: 20 A8 A0  LDA ram_07AA_unk,X
                                        AND #$0F
                                        CMP #$05
...
bra_B10B:
C - - - - - 0x00B11B 02:B10B: 20 A2 A0  LDA ram_07AA_unk,X
                                        AND #$0F
