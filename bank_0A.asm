...
C - - - - - 0x01405A 05:804A: B9 14 81  LDA tbl_8113 + 1,Y
...
C - - - - - 0x0141F5 05:81E5: 05 41     ORA ram_btn_press_1 + 1
...
C - - - - - 0x014258 05:8248: 85 79     STA ram_chr_bank + 2
...
C - - - - - 0x014261 05:8251: 85 FD     STA ram_00FD
C - - - - - 0x014263 05:8253: 85 FC     STA ram_00FC
C - - - - - 0x014265 05:8255: 85 5A     STA ram_005A
...
C - - - - - 0x01434D 05:833D: B9 0B 8D  LDA tbl_8D0A + 1,Y
...
C - - - - - 0x014369 05:8359: 84 20     STY ram_0020
...
C - - - - - 0x01437E 05:836E: 85 76     STA ram_0076
...
C - - - - - 0x014391 05:8381: 85 20     STA ram_0020
C - - - - - 0x014393 05:8383: 85 44     STA ram_0044
...
sub_83B2:
C - - - - - 0x0143C4 05:83B4: B9 02 84  LDA #< tbl_84F2
C - - - - - 0x0143C7 05:83B7: 85 00     STA ram_0000
C - - - - - 0x0143C9 05:83B9: B9 03 84  LDA #> tbl_84F2
...
C - - - - - 0x0143F6 05:83E6: B9 F1 83  LDA tbl_83F0 + 1,Y
...
C - - - - - 0x014576 05:8566: BD B0 03  LDA ram_03B0,X
...
C - - - - - 0x014582 05:8572: BD B0 03  LDA ram_03B0,X
...
bra_857D:
loc_857D:
C D 0 - - - 0x01458D 05:857D: 9D D0 03  STA ram_03D0,X
...
C - - - - - 0x0145B1 05:85A1: 79 BD 85  ADC #< tbl_85BF
C - - - - - 0x0145B4 05:85A4: 85 00     STA ram_0000
C - - - - - 0x0145B6 05:85A6: B9 BE 85  LDA #> tbl_85BF
...
C - - - - - 0x0146AF 05:869F: 85 34     STA ram_0034
...
ofs_020_86CE_44:
C - - J - - 0x0146DE 05:86CE: A9 06     LDA #$06
C - - - - - 0x0146E0 05:86D0: 85 76     STA ram_0076
...
C - - - - - 0x0146EC 05:86DC: 85 5A     STA ram_005A
...
C - - - - - 0x014715 05:8705: 85 FD     STA ram_00FD
...
C - - - - - 0x014764 05:8754: B9 9E 88  LDA tbl_88A0 - 2,Y
C - - - - - 0x014767 05:8757: 85 06     STA ram_0006
C - - - - - 0x014769 05:8759: B9 9F 88  LDA tbl_88A0 - 1,Y
...
C - - - - - 0x014779 05:8769: B9 EB 87  LDA tbl_87EA_credits + 1,Y
...
C - - - - - 0x014926 05:8916: B9 47 89  LDA tbl_8946 + 1,Y
...
C - - - - - 0x01493E 05:892E: 0D 1B 06  ORA ram_obj_animation_lo + 1
...
C - - - - - 0x014AD7 05:8AC7: 85 7C     STA ram_chr_bank + 5
...
C - - - - - 0x014AF2 05:8AE2: B9 84 8B  LDA tbl_8B83 + 1,Y
...
C - - - - - 0x014BEA 05:8BDA: B9 EE 8B  LDA tbl_8BED + 1,Y
...
C - - - - - 0x014C44 05:8C34: B9 5B 8D  LDA tbl_8D5A_cutscene_text + 1,Y
...
C - - - - - 0x014C65 05:8C55: B9 03 8D  LDA tbl_8D02_ppu + 1,Y
...
off_8D0E_00:
- D 0 - I - 0x014D1E 05:8D0E: E2 21     .word $21E2
...
off_8D34_01:
- D 0 - I - 0x014D44 05:8D34: 82 22     .word $2282
...
C - - - - - 0x015722 05:9712: 84 5A     STY ram_005A
...
C - - - - - 0x015754 05:9744: 85 FC     STA ram_00FC
C - - - - - 0x015756 05:9746: A9 F8     LDA #$F8
C - - - - - 0x015758 05:9748: 85 FD     STA ram_00FD
...
C - - - - - 0x015792 05:9782: 85 5A     STA ram_005A
...
C - - - - - 0x0157E8 05:97D8: A5 B2     LDA ram_current_player + 1
...
C - - - - - 0x015800 05:97F0: 85 79     STA ram_chr_bank + 2
C - - - - - 0x015802 05:97F2: B9 05 98  LDA tbl_9804 + 1,Y
C - - - - - 0x015805 05:97F5: 85 7A     STA ram_chr_bank + 3
...
C - - - - - 0x015867 05:9857: B9 48 99  LDA tbl_9947 + 1,Y
C - - - - - 0x01586A 05:985A: 85 60     STA ram_0060
C - - - - - 0x01586C 05:985C: B9 49 99  LDA tbl_9947 + 2,Y
C - - - - - 0x01586F 05:985F: 85 64     STA ram_0064
C - - - - - 0x015871 05:9861: B9 4A 99  LDA tbl_9947 + 3,Y
...
C - - - - - 0x015884 05:9874: A5 34     LDA ram_0034
...
C - - - - - 0x0159BE 05:99AE: 9D B8 03  STA ram_03B8,X
...
C - - - - - 0x0159DE 05:99CE: A5 5A     LDA ram_005A
...
C - - - - - 0x015A16 05:9A06: B9 CE 9E  LDA tbl_9ECD + 1,Y
...
C - - - - - 0x015A4F 05:9A3F: A5 76     LDA ram_0076
C - - - - - 0x015A51 05:9A41: C9 03     CMP #$03
...
bra_9A96:
C - - - - - 0x015AA6 05:9A96: 85 5A     STA ram_005A
C - - - - - 0x015AA8 05:9A98: A9 03     LDA #$03
C - - - - - 0x015AAA 05:9A9A: 85 76     STA ram_0076
...
bra_9AC4:
loc_9AC4:
C D 0 - - - 0x015AD4 05:9AC4: A9 01     LDA #$01
C - - - - - 0x015AD6 05:9AC6: C5 76     CMP ram_0076
...
bra_9B36:
C - - - - - 0x015B46 05:9B36: A5 76     LDA ram_0076
C - - - - - 0x015B48 05:9B38: C9 03     CMP #$03
...
C - - - - - 0x015CAC 05:9C9C: B9 22 9F  LDA tbl_9F21 + 1,Y
...
C - - - - - 0x015D21 05:9D11: B9 DA 9E  LDA tbl_9ED9 + 1,Y
...
C - - - - - 0x015E21 05:9E11: 85 FD     STA ram_00FD
...
C - - - - - 0x015E30 05:9E20: 85 FC     STA ram_00FC
...
C - - - - - 0x015E9D 05:9E8D: 85 FD     STA ram_00FD
...
C - - - - - 0x015EB2 05:9EA2: A5 FC     LDA ram_00FC
C - - - - - 0x015EB4 05:9EA4: 18        CLC
C - - - - - 0x015EB5 05:9EA5: 79 B7 F5  ADC tbl_0x01F5C6 + 1,Y
...
C - - - - - 0x015F83 05:9F73: B9 A5 9F  LDA tbl_9FA4 + 1,Y
...
C - - - - - 0x016202 05:A1F2: 79 B7 F5  ADC tbl_0x01F5C6 + 1,Y
...
C - - - - - 0x01626A 05:A25A: 05 43     ORA ram_btn_hold_1 + 1
...
C - - - - - 0x01630C 05:A2FC: B9 05 A3  LDA tbl_A304 + 1,Y
...
C - - - - - 0x01639E 05:A38E: 85 7C     STA ram_chr_bank + 5
...
bra_A396:
C - - - - - 0x0163A6 05:A396: 85 5A     STA ram_005A
bra_A398:
sub_A398:
...
C - - - - - 0x016473 05:A463: 05 41     ORA ram_btn_press_1 + 1
...
C - - - - - 0x0164E8 05:A4D8: 05 43     ORA ram_btn_hold_1 + 1
...
bra_A4EC:
C - - - - - 0x0164FC 05:A4EC: AD 83 07  LDA ram_0782_unk + 1
...
C - - - - - 0x01650A 05:A4FA: 8D 83 07  STA ram_0782_unk + 1
...
bra_A5E0_loop:
C - - - - - 0x0165F0 05:A5E0: 9D 74 03  STA ram_0374,X
...
C - - - - - 0x0165FC 05:A5EC: 8D 74 03  STA ram_0374
bra_A5EF:
...
C - - - - - 0x016615 05:A605: 85 79     STA ram_chr_bank + 2
...
C - - - - - 0x01668F 05:A67F: B9 2A A7  LDA tbl_A729 + 1,Y
...
C - - - - - 0x01669B 05:A68B: B9 3A A7  LDA tbl_A739 + 1,Y
...
C - - - - - 0x0166B5 05:A6A5: B9 22 A7  LDA tbl_A721 + 1,Y
...
C - - - - - 0x0166E4 05:A6D4: B9 DA A8  LDA tbl_A8D9 + 1,Y
...
- D 1 - I - 0x016AA8 05:AA98: D5        .byte $D5, $D6, $D6, $D6   ; 
...
- - - - - - 0x0170E0 05:B0D0: B9 4B F9  LDA tbl_0x01F95A + 1,Y
bra_B0D3:
...
ofs_006_0x01711D_0E:
C - - J - - 0x01711D 05:B10D: A5 20     LDA ram_0020
...
C - - - - - 0x017145 05:B135: B9 74 03  LDA ram_0374,Y
...
C - - - - - 0x017159 05:B149: 99 74 03  STA ram_0374,Y
...
bra_B158:
C - - - - - 0x017168 05:B158: B9 75 03  LDA ram_0375,Y
C - - - - - 0x01716B 05:B15B: 18        CLC
C - - - - - 0x01716C 05:B15C: 69 01     ADC #$01
C - - - - - 0x01716E 05:B15E: 99 75 03  STA ram_0375,Y
...
C - - - - - 0x01717D 05:B16D: B9 75 03  LDA ram_0375,Y
C - - - - - 0x017180 05:B170: 38        SEC
C - - - - - 0x017181 05:B171: E9 01     SBC #$01
C - - - - - 0x017183 05:B173: 99 75 03  STA ram_0375,Y
...
bra_B189:
C - - - - - 0x017199 05:B189: B9 74 03  LDA ram_0374,Y
C - - - - - 0x01719C 05:B18C: 29 0F     AND #$0F
C - - - - - 0x01719E 05:B18E: 85 00     STA ram_0000
C - - - - - 0x0171A0 05:B190: B9 74 03  LDA ram_0374,Y
...
C - - - - - 0x0171AF 05:B19F: 8D 74 03  STA ram_0374
C - - - - - 0x0171B2 05:B1A2: A9 10     LDA #$10
C - - - - - 0x0171B4 05:B1A4: 8D 75 03  STA ram_0375
C - - - - - 0x0171B7 05:B1A7: E6 C3     INC ram_00C3
C - - - - - 0x0171B9 05:B1A9: 20 B5 B1  JSR sub_B1B5
C - - - - - 0x0171BC 05:B1AC: 8D 76 03  STA ram_0376
C - - - - - 0x0171BF 05:B1AF: A9 01     LDA #$01
C - - - - - 0x0171C1 05:B1B1: 8D 77 03  STA ram_0377
...
C - - - - - 0x0171FE 05:B1EE: B9 DD B2  LDA tbl_B2DC + 1,Y
...
C - - - - - 0x01720D 05:B1FD: B9 0B B3  LDA tbl_B30A + 1,Y
...
C - - - - - 0x017249 05:B239: 2D 74 03  AND ram_0374
C - - - - - 0x01724C 05:B23C: F0 11     BEQ bra_B24F
- - - - - - 0x01724E 05:B23E: 2D 75 03  AND ram_0375
- - - - - - 0x017251 05:B241: D0 0C     BNE bra_B24F
- - - - - - 0x017253 05:B243: AD 77 03  LDA ram_0377
- - - - - - 0x017256 05:B246: F0 03     BEQ bra_B24B
- - - - - - 0x017258 05:B248: 8D 78 03  STA ram_0378
bra_B24B:
- - - - - - 0x01725B 05:B24B: A9 0F     LDA #$0F
- - - - - - 0x01725D 05:B24D: D0 07     BNE bra_B256    ; jmp
bra_B24F:
C - - - - - 0x01725F 05:B24F: AD 77 03  LDA ram_0377
...
C - - - - - 0x017278 05:B268: AD 77 03  LDA ram_0377
...
C - - - - - 0x017296 05:B286: 2D 74 03  AND ram_0374
...
bra_B295:
C - - - - - 0x0172A5 05:B295: 2D 74 03  AND ram_0374
C - - - - - 0x0172A8 05:B298: F0 0D     BEQ bra_B2A7
- - - - - - 0x0172AA 05:B29A: 2D 75 03  AND ram_0375
...
C - - - - - 0x017346 05:B336: 8D 74 03  STA ram_0374
bra_B339:
sub_B339:
...
- - - - - - 0x017427 05:B417: 2D 74 03  AND ram_0374
...
sub_B456:
C - - - - - 0x017466 05:B456: AC 77 03  LDY ram_0377
...
ofs_009_B498_04:
C - - J - - 0x0174A8 05:B498: AC 77 03  LDY ram_0377
...
C - - - - - 0x01756E 05:B55E: B9 86 B6  LDA tbl_B685 + 1,Y
...
C - - - - - 0x017583 05:B573: 2D 79 03  AND ram_0379
C - - - - - 0x017586 05:B576: 8D 79 03  STA ram_0379
...
C - - - - - 0x01759E 05:B58E: AD 79 03  LDA ram_0379
C - - - - - 0x0175A1 05:B591: 19 AE F5  ORA tbl_0x01F5BE,Y
C - - - - - 0x0175A4 05:B594: 8D 79 03  STA ram_0379
bra_B597:
...
C - - - - - 0x0175B3 05:B5A3: 2D 7A 03  AND ram_037A
C - - - - - 0x0175B6 05:B5A6: 8D 7A 03  STA ram_037A
C - - - - - 0x0175B9 05:B5A9: A5 00     LDA ram_0000
C - - - - - 0x0175BB 05:B5AB: F0 0B     BEQ bra_B5B8
- - - - - - 0x0175BD 05:B5AD: A4 0F     LDY ram_000F
- - - - - - 0x0175BF 05:B5AF: AD 7A 03  LDA ram_037A
- - - - - - 0x0175C2 05:B5B2: 19 AE F5  ORA tbl_0x01F5BE,Y
- - - - - - 0x0175C5 05:B5B5: 8D 7A 03  STA ram_037A
bra_B5B8:
C - - - - - 0x0175C8 05:B5B8: AC 7A 03  LDY ram_037A
C - - - - - 0x0175CB 05:B5BB: 8C 75 03  STY ram_0375
C - - - - - 0x0175CE 05:B5BE: AC 79 03  LDY ram_0379
C - - - - - 0x0175D1 05:B5C1: 8C 74 03  STY ram_0374
...
C - - - - - 0x0175F2 05:B5E2: 8D 76 03  STA ram_0376
C - - - - - 0x0175F5 05:B5E5: 8D 77 03  STA ram_0377
C - - - - - 0x0175F8 05:B5E8: 8D 83 03  STA ram_0383
...
C - - - - - 0x01761D 05:B60D: CC 78 03  CPY ram_0378
...
C - - - - - 0x017644 05:B634: 8C 83 03  STY ram_0383
...
- - - - - - 0x017657 05:B647: 0D 76 03  ORA ram_0376
- - - - - - 0x01765A 05:B64A: 8D 76 03  STA ram_0376
bra_B64D:
C - - - - - 0x01765D 05:B64D: E6 1F     INC ram_001F
C - - - - - 0x01765F 05:B64F: C6 1E     DEC ram_001E
C - - - - - 0x017661 05:B651: D0 A0     BNE bra_B5F3
C - - - - - 0x017663 05:B653: AD 83 03  LDA ram_0383
C - - - - - 0x017666 05:B656: 8D 77 03  STA ram_0377
...
C - - - - - 0x0176E7 05:B6D7: B9 E2 B6  LDA tbl_B6E4 - 2,Y
C - - - - - 0x0176EA 05:B6DA: 85 00     STA ram_0000
C - - - - - 0x0176EC 05:B6DC: B9 E3 B6  LDA tbl_B6E4 - 1,Y
...
C - - - - - 0x0177C9 05:B7B9: 85 FC     STA ram_00FC
...
C - - - - - 0x017873 05:B863: A9 05     LDA #$05
C - - - - - 0x017875 05:B865: 85 76     STA ram_0076
bra_B867:
...
C - - - - - 0x017960 05:B950: AD AF 07  LDA ram_07AA_unk + 5
...
C - - - - - 0x017971 05:B961: 8D AF 07  STA ram_07AA_unk + 5
bra_B964:
C - - - - - 0x017974 05:B964: AD AF 07  LDA ram_07AA_unk + 5
C - - - - - 0x017977 05:B967: 29 7F     AND #$7F
C - - - - - 0x017979 05:B969: A8        TAY
C - - - - - 0x01797A 05:B96A: B9 AE B9  LDA tbl_B9AE,Y
C - - - - - 0x01797D 05:B96D: 8D 53 06  STA ram_obj_pos_X + 5
C - - - - - 0x017980 05:B970: 85 00     STA ram_0000
C - - - - - 0x017982 05:B972: A9 28     LDA #$28
C - - - - - 0x017984 05:B974: 8D 6D 06  STA ram_obj_pos_Y + 5
...
bra_B99E:
C - - - - - 0x0179AE 05:B99E: EE AF 07  INC ram_07AA_unk + 5
C - - - - - 0x0179B1 05:B9A1: AD AF 07  LDA ram_07AA_unk + 5
C - - - - - 0x0179B4 05:B9A4: C9 86     CMP #$86
C - - - - - 0x0179B6 05:B9A6: 90 05     BCC bra_B9AD_RTS
C - - - - - 0x0179B8 05:B9A8: A9 00     LDA #$00
C - - - - - 0x0179BA 05:B9AA: 8D AF 07  STA ram_07AA_unk + 5
bra_B9AD_RTS:
...
C - - - - - 0x017A02 05:B9F2: B9 03 BA  LDA tbl_BA05 - 2,Y
C - - - - - 0x017A05 05:B9F5: 85 00     STA ram_0000
C - - - - - 0x017A07 05:B9F7: B9 04 BA  LDA tbl_BA05 - 1,Y
...
C - - - - - 0x017AD7 05:BAC7: A9 03     LDA #$03
bra_BAC9:
C - - - - - 0x017AD9 05:BAC9: 85 76     STA ram_0076
...
bra_BB32:
C - - - - - 0x017B42 05:BB32: A9 07     LDA #$07
C - - - - - 0x017B44 05:BB34: 85 76     STA ram_0076
...
C - - - - - 0x017B8F 05:BB7F: C5 20     CMP ram_0020
...
C - - - - - 0x017B9A 05:BB8A: B9 C2 BB  LDA tbl_BBC1 + 1,Y
...
C - - - - - 0x017BAE 05:BB9E: A5 20     LDA ram_0020
...
C - - - - - 0x017BFC 05:BBEC: A5 20     LDA ram_0020
...
C - - - - - 0x017C95 05:BC85: B9 B8 BC  LDA tbl_BCB7 + 1,Y
...
C - - - - - 0x017D6B 05:BD5B: D9 F6 BD  CMP tbl_BDF6,Y
C - - - - - 0x017D6E 05:BD5E: 90 03     BCC bra_BD63
C - - - - - 0x017D70 05:BD60: B9 F6 BD  LDA tbl_BDF6,Y
bra_BD63:
...
C - - - - - 0x017D7D 05:BD6D: B9 F6 BD  LDA tbl_BDF6,Y
...
C - - - - - 0x017D93 05:BD83: 79 F1 BD  ADC tbl_BDF1,Y
C - - - - - 0x017D96 05:BD86: 85 00     STA ram_0000
C - - - - - 0x017D98 05:BD88: B9 F2 BD  LDA tbl_BDF2,Y
...
C - - - - - 0x017DAF 05:BD9F: B9 FA BD  LDA tbl_BDF9 + 1,Y
...
tbl_BDF1:
- D 1 - - - 0x017E01 05:BDF1: E8        .byte $E8   ; 
tbl_BDF2:
- D 1 - - - 0x017E02 05:BDF2: 21        .byte $21   ; 
- D 1 - - - 0x017E03 05:BDF3: F6        .byte $F6   ; 
- D 1 - - - 0x017E04 05:BDF4: 21        .byte $21   ; 
tbl_BDF5:
- D 1 - - - 0x017E05 05:BDF5: 28        .byte $28   ; 
tbl_BDF6:
- D 1 - - - 0x017E06 05:BDF6: 0E        .byte $0E   ; 
- D 1 - - - 0x017E07 05:BDF7: 36        .byte $36   ; 
- D 1 - - - 0x017E08 05:BDF8: 01        .byte $01   ; 
