...
set "sha1_original=9FA1EE5FCACADA43CFDA91773C7298C722B7D990"
...
if %fast_assembly% equ 1 (
    ...
    ca65 -U copy_bank_21.asm
    ca65 -U copy_bank_22.asm
    ca65 -U copy_bank_23.asm
