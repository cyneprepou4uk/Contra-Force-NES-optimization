...
C - - - - - 0x00352C 00:B51C: 20 78 9A  JSR sub_9A78_drop_a_box_with_powerup
bra_B51F:
...
sub_9A78_drop_a_box_with_powerup:
...
tbl_B893:
- D 1 - - - 0x0038A3 00:B893: 32        .byte $32   ; 01 обычная маленькая пуля
...
- D 1 - - - 0x0038AB 00:B89B: 36        .byte $36   ; 09 кружок при исчезновении обычной маленькой пули
