...
sub_0x0080C6:   ; переместить как можно быстрее
...
ofs_006_0x00A058_23:    ; безопасно для перемещения
; con_F3D6_23
...
C - - - - - 0x008123 02:8113: C9 A3     CMP #$23 + $80
...
- - - - - - 0x008381 02:8371: 45 A7     .word ofs_017_0x00E755_3C   ; unused?
...
- - - - - - 0x0083AB 02:839B: 23 AD     .word ofs_017_0x00ED33_51   ; unused?
...
- - - - - - 0x0083B3 02:83A3: 23 AD     .word ofs_017_0x00ED33_55   ; unused?
- D 0 - - - 0x0083B5 02:83A5: A0 AE     .word ofs_017_0x00EEB0_56
- D 0 - - - 0x0083B7 02:83A7: E3 8F     .word ofs_017_0x008FF3_57
...
- D 0 - - - 0x0083BF 02:83AF: 20 8D     .word ofs_017_0x008D30_5B
...
; copy speed
C - - - - - 0x0084C6 02:84B6: 20 47 91  LDA ram_obj_spd_X,X
                                        STA ram_obj_spd_X,Y
                                        LDA ram_obj_spd_Y,X
                                        STA ram_obj_spd_Y,Y
; copy position
C - - - - - 0x0084C9 02:84B9: 20 54 91  LDA ram_obj_pos_X,X
                                        STA ram_obj_pos_X,Y
                                        LDA ram_obj_pos_Y,X
                                        STA ram_obj_pos_Y,Y
; 
C - - - - - 0x0084CC 02:84BC: 20 61 91  LDA #$13
                                        STA ram_0720_obj,Y
                                        LDA #$00
                                        STA ram_obj_animation_lo,Y
                                        STA ram_069C_obj,Y
                                        STA ram_0736_obj,Y
; A = 00
...
C - - - - - 0x0085BB 02:85AB: 4C 10 8C  SEC
                                        SBC #$01
                                        STA ram_0778_unk,X
                                        SEC
                                        RTS
...
- D 0 - - - 0x008A43 02:8A33: 1C        .byte $1C, $80 + $07   ; 32 обычная маленькая пуля
- D 0 - - - 0x008A45 02:8A35: 02        .byte $02, $80 + $07   ; 33 
- D 0 - - - 0x008A47 02:8A37: 03        .byte $03, $80 + $07   ; 34 
- D 0 - - - 0x008A49 02:8A39: 1D        .byte $1D, $80 + $07   ; 35 
- D 0 - - - 0x008A4B 02:8A3B: 1E        .byte $1E, $80 + $07   ; 36 кружок при исчезновении обычной маленькой пули
...
; 
bra_8B89:
C - - - - - 0x008B99 02:8B89: 20 78 91  LDA ram_stage
                                        AND #$01
...
bra_AA03:
C - - - - - 0x00EA13 03:AA03: 4C 16 AD  LDY #$01
                                        JSR sub_0x00E933
                                        SEC
                                        RTS
...
C - - - - - 0x00E9BE 03:A9AE: 20 23 A9  JSR sub_0x00E933
...
.export loc_0x00ED33
loc_0x00ED33:
C - - - - - 0x00ED33 03:AD23: 20 1D AD  JSR sub_0x01F6D1
                                        JSR sub_0x0093CA
C - - - - - 0x00ED36 03:AD26: B0 5B     BCS bra_AD83
C - - - - - 0x00ED38 03:AD28: 20 8D AD  JSR sub_AD8D
C - - - - - 0x00ED3B 03:AD2B: 20 BD A9  JSR sub_0x00E9CD
...
C - - - - - 0x00EDC0 03:ADB0: 4C 6D AB  LDA #$00
                                        STA ram_0098_counter
                                        SEC
                                        RTS
