...
C - - - - - 0x01401F 05:800F: 20 14 82  LDA #$00
                                        STA ram_0022_t02
...
C - - - - - 0x01402D 05:801D: 4C 43 80  JSR sub_8043
; 
...
sub_0x008BE0:
; copy position
C - - - - - 0x008BE0 02:8BD0: 20 54 91  LDA ram_obj_pos_X,X
                                        STA ram_obj_pos_X,Y
                                        LDA ram_obj_pos_Y,X
                                        STA ram_obj_pos_Y,Y
.export sub_0x008BE3
...
; copy speed
C - - - - - 0x008BE9 02:8BD9: 20 47 91  LDA ram_obj_spd_X,X
                                        STA ram_obj_spd_X,Y
                                        LDA ram_obj_spd_Y,X
                                        STA ram_obj_spd_Y,Y
; 
C - - - - - 0x008BEC 02:8BDC: 20 61 91  LDA #$13
                                        STA ram_0720_obj,Y
                                        LDA #$00
...
; 
C - - - - - 0x008C0C 02:8BFC: 20 E3 93  LDA ram_0782_unk,Y
                                        AND #$7F
                                        TAX
                                        LDA tbl_93F0 - $01,X
                                        STA ram_0796_unk,Y
